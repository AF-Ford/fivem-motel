...
AddEventHandler('esx_sommen_motel:session:invite', function(source, target, apartment, x, y, z)
	TriggerClientEvent('esx_sommen_motel:gotInvite', target, source, apartment, x, y, z)
end)

RegisterServerEvent('esx_sommen_motel:session:acceptInvite')
AddEventHandler('esx_sommen_motel:session:acceptInvite', function(source, targetSource, x, y, z)
	TriggerEvent('esx_sommen_motel:session:join', source, targetSource, x, y, z)
end)
